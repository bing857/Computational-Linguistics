...
def HMM(A_01, A_10):
    pi_dict, state0, state1=Initialization(A_01, A_10)
    ...
    epsilon=0.1
    improvement = 1.0
    initial_sum_plogs=fileRunnerPlog("./english1000.txt", pi_dict, state0, state1)
    iteration=0
    ...
    # for i in range(10):
        iteration+=1
        softCounts, initialSoftCounts=expectation("./english1000.txt", pi_dict, state0, state1)
        ...
        current_sum_plogs=fileRunnerPlog("./english1000.txt", pi_dict, state0, state1)
    ...
    # print("\n\n\n")
    # print(current_sum_plogs)
    return current_sum_plogs
    # print(oldpi_dict, oldstate_0, oldstate_1, sep='\n')
        # initial_sum_plogs=current_sum_plogs

def tableGen():
    # tablestruct[A_01][A_10]

    tablestruct={"0.8":{"0.2":0, "0.4":0, "0.6":0, "0.8":0}, "0.6":{"0.2":0, "0.4":0, "0.6":0, "0.8":0}, "0.4":{"0.2":0, "0.4":0, "0.6":0, "0.8":0}, "0.2":{"0.2":0, "0.4":0, "0.6":0, "0.8":0}, }
    for A_01 in tablestruct.keys():
        for A_10 in tablestruct[A_01].keys():
            tablestruct[A_01][A_10]=HMM(float(A_01), float(A_10))
    # tablestruct["0.2"]["0.8"]=21574.34374320178
    # tablestruct["0.2"]["0.6"]=22244.351880121812
    # tablestruct["0.2"]["0.4"]=21741.394061034513
    # tablestruct["0.2"]["0.2"]=21752.820910372306
    # tablestruct["0.4"]["0.8"]=21568.942926860087
    # tablestruct["0.4"]["0.6"]=22255.492743974148
    # tablestruct["0.4"]["0.4"]=21750.763253510024
    # tablestruct["0.4"]["0.2"]=21747.95169982155
    # tablestruct["0.6"]["0.8"]=21447.919435369568
    # tablestruct["0.6"]["0.6"]=21496.082951682856
    # tablestruct["0.6"]["0.4"]=21574.331127140176
    # tablestruct["0.6"]["0.2"]=21753.738484975904
    # tablestruct["0.8"]["0.8"]=21454.73590971577
    # tablestruct["0.8"]["0.6"]=21494.8980842282
    # tablestruct["0.8"]["0.4"]=21496.715582471687
    # tablestruct["0.8"]["0.2"]=21531.74026879473
...
def printTable(table):
    xlabel=['']+list(table["0.2"].keys())
    ylabel=list(table.keys())
    for letter in xlabel:
        print('--------------', end='')
    print()
    for letter in xlabel:
        print(letter.center(15), end='')
    print()
    for letter in xlabel:
        print('--------------', end='')
    print()
    for A_01 in ylabel:
        print(A_01.center(15), end='')
        for A_02 in table[A_01]:
            print(str(round(table[A_01][A_02], 5)).center(15), end="")
        print()
    for letter in xlabel:
        print('--------------', end='')
    print("\n\n\n")
